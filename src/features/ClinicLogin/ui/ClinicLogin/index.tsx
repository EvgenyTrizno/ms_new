...
import { useClinicLoginMutation } from "@/shared/lib/hooks/useClinicLoginMutation";

export const ClinicLogin: FC = () => {
    const [numberOrEmail, setNumberOrEmail] = useState<string>("");
    const [password, setPassword] = useState<string>("");
    const { mutate, error, isLoading } = useClinicLoginMutation(
        numberOrEmail,
        password
    );

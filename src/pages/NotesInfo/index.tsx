              ...
              <div className={styles.stats} id="statsCircle">
                <div className={styles.box} id="circle">
                  <Circle
                    ...
                    circleColor={"#F2F4F5"}
                    textColor="#000"
                    percentColor={sick ? "#D64657" : "#FF8181"}
                  />
                ...
                <div className={styles.box}>
                  <Circle
                    ...
                    circleColor={"#F2F4F5"}
                    textColor="#000"
                    percentColor={sick ? "#D64657" : "#81B3FF"}
                  />
                  <div className={styles.text}>
                    <Text type="h2" fz="16px">
                      Помогло на 60%
                ...
                <div className={styles.box}>
                  ...
                  <div className={styles.text}>
                    ...
                    <Text type="p" fz="14px" color="#3BB948">
                      600 пациентов
                    </Text>
                  </div>
                </div>
        ...
        <div className={styles.box}>
          <div className={styles.comments}>
            ...
            <div className={styles.items}>
              <Comment name="Александр Петров" title="Классные специалисты!">

...
const CenterPage: FC = () => {
  ...
  return (
    <Layout>
      {MOBILE && (
        <CustomMobileHeader back text="Профиль центра"></CustomMobileHeader>
      )}
      <Container>
        <AdminPanelContainer>
          <Cols
          ...
          >
            ...
            <MedicalCenterinfoLayout
              ...
              country={`${center?.country}, ${center?.city}`}
            ...
            <Rows gap={10} rows={["auto"]}>
              <AdminInfo
                name={`${center?.admin && center?.admin?.last_name} ${
                  center?.admin && center?.admin?.first_name
                } ${center?.admin && center?.admin?.surname}`}
                number={(center?.admin && center.admin.number) ?? ""}
              />
              <StatusInfo
                    ...
                    <BlueBox>
                      <Row gap={10}>
                        ...
                        <Rows gap={0} rows={["auto"]}>
                          ...
                          <Text type="p" fz="14x" color="#3C3D3E">
                            Записей
                          </Text>
                        </Rows>
                      </Row>
          ...
          >
            <IncomeBlock title="Баланс на счету" data={incomeData} />
            <Chart />
          </Cols>
          <Row gap={10}>
            <Search
          ...
          <EmployeesList data={data?.data.center[0].employees ?? []} />
        </AdminPanelContainer>
      </Container>
    </Layout>
  );
